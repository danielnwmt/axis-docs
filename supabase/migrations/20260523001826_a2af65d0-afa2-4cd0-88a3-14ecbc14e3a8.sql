...
REVOKE EXECUTE ON FUNCTION public.record_consent(text, text, text, text) FROM PUBLIC;
...
REVOKE EXECUTE ON FUNCTION public.request_data_action(text, text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.get_my_data_export() FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.insert_audit_log(text, text, text, text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.report_incident_anpd(uuid, text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.resolve_incident(uuid, text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.notify_incident_subjects(uuid) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.log_pii_access(text, text, uuid, text) FROM PUBLIC;
